...
Create Frogport peripheral. Manages addresses, configurations, inventory, and package send/receive events. All methods are mainThread=true, so no imm variants are available.
