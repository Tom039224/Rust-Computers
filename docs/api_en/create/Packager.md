...
Create Packager peripheral. Creates packages from inventory contents, manages addresses, and listens for package send/receive events.
...
// Wait for a package to be received
