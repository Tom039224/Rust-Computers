...
**Module:** `create`  
**Peripheral Type:** `create:packager`

Create Packager peripheral. Creates packages from inventory contents and manages package addresses.
...
// Set address and create a package
packager.book_next_set_address("destination");
...
// Wait for package to be sent
let sent = packager.pull_package_sent().await?;
```
