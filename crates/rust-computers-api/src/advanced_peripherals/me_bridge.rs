...
pub struct MEFluidEntry {
    ...
    #[serde(rename = "displayName")]
    pub display_name: String,
    #[serde(rename = "fluidType", default)]
    pub fluid_type: crate::msgpack::Value,
    #[serde(default)]
    pub components: crate::msgpack::Value,
    #[serde(default)]
    pub fingerprint: String,
...
pub struct MEChemicalEntry {
    ...
    #[serde(default)]
    pub tags: Vec<String>,
    #[serde(rename = "isGaseous", default)]
    pub is_gaseous: Option<bool>,
    #[serde(default)]
