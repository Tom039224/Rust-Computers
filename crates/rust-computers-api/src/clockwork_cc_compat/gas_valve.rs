...
impl Peripheral for GasValve {
    const NAME: &'static str = "cw_gas_valve";
...
impl GasValve {
    ...
    imm_getter!(book_next_get_aperture, read_last_get_aperture, get_aperture_imm, "getAperture", f64);
...
impl GasValve {
    pub async fn async_get_aperture(&mut self) -> Result<f64, PeripheralError> {
        self.book_next_get_aperture();
        crate::wait_for_next_tick().await;
        self.read_last_get_aperture()
    }
