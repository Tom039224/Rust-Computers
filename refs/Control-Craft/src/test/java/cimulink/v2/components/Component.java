...
import cimulink.v2.utils.ArrayUtils;
...
public abstract class Component {
    ...
    public boolean immediate(int index){
        ArrayUtils.AssertRange(index, m());
        return immediateInternal(index);
    }

    protected abstract boolean immediateInternal(int index);
