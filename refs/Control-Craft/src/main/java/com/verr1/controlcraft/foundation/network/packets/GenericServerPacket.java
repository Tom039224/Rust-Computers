...
public class GenericServerPacket extends BlockBoundPacket{
    ...
    protected GenericServerPacket(BlockPos boundPos, RegisteredPacketType type, List<Double> doubles, List<Long> longs, List<String> utf8s, List<Boolean> booleans) {
        super(boundPos, type, doubles, longs, utf8s, booleans);

    }

    public GenericServerPacket(FriendlyByteBuf buf) {
        super(buf);
    }

    @Override
    public boolean handle(NetworkEvent.Context context) {
        context.enqueueWork(() -> ServerGenericPacketHandler.dispatchPacket(this, context));
        return true;
    }
    ...
    public static class builder{
        ...
        public GenericServerPacket build(){
            return new GenericServerPacket(boundPos, type, doubles, longs, utf8s, booleans);
        }
